...
const cards = [
  ...
  },
  {
    ...
    features: [
      ...
      "Self-Learning Credit Intelligence: AI models learn MSME behavior from transaction data",
      "End-to-End Loan Lifecycle: underwriting through disbursement, repayments, monitoring, and credit limits",
    ],
    cta: "Explore",
  ...
  },
  {
    ...
    features: [
      ...
      "Consent-based interoperability across lenders for coordinated credit assessments",
      "Privacy-preserving architecture with secure storage and cryptographic verification",
    ],
    cta: "Discover",
