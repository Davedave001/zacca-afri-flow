...
const cards = [
  {
    ...
    description: "",
    features: [
      "The moment your lender approves your credit, funds land in the Zacca Wallet, mobile money, or a linked bank account — no delays, no paperwork.",
      "Repayments are intelligently deducted from incoming transactions on the schedule you and your lender agree to.",
      "Fast transfers between the Zacca Wallet, mobile money platforms, and bank accounts keep daily operations moving.",
    ],
    cta: "Learn More",
  ...
  },
  {
    ...
    description: "",
    features: [
      "Embedded lending connects banks, SACCOs, microlenders, digital lenders, and mobile money into one credit ecosystem.",
      "Pattern recognition surfaces how an MSME actually behaves — income streams, repayment consistency, seasonal dips — as clear evidence your lender's underwriting team reviews, not a black-box score.",
      "End-to-end lifecycle support from application evidence through disbursement, repayment tracking, and monitoring — with a human underwriter in the loop at every decision.",
    ],
    cta: "Explore",
  ...
  },
  {
    ...
    description: "",
    features: [
      "MSME activity tracking that goes beyond formal transactions — capturing chama-level and informal-economy financial behavior most lenders never see.",
      "Consent-based interoperability across lenders that enables coordinated, faster credit assessments.",
